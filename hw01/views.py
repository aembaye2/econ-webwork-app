...
from .models import Question, Student  # comes from local directory not library
# comes from local directory not library
...
def questions(request):
    ...
    print(f"Fetched {questions.count()} questions")  # Debug statement
